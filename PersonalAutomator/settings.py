...
INSTALLED_APPS = [
    ...
    # Third-party apps
    'corsheaders',  # To handle CORS for React
...
ROOT_URLCONF = 'PersonalAutomator.urls'  # Replace 'YourProjectName' with your project folder name
...
# Optional logging for debugging during development
if DEBUG:
    LOGGING = {
        'version': 1,
